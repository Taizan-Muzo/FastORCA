...
QCMOL_ALIGNMENT_MASTER_TABLE: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "current_status": "implemented_proxy",
        "next_action": "keep",
        "completion_criterion": "Density-shape descriptor family v1 (0.95 canonical scale) and multiscale companions (0.50/0.90/0.95) remain stable; legacy density_sphericity_like kept as compatibility alias.",
        "notes": "Explicitly proxy substitute; family includes sphericity/asphericity/anisotropy/relative_anisotropy_kappa2/elongation/planarity with multiscale companion outputs.",
    },
    {
        "section": "global_features",
        ...
        "current_status": "implemented_proxy",
        "next_action": "keep",
        "completion_criterion": "Primary bbox-diagonal and companion size proxies remain stable with documented source priority.",
        "notes": "Frozen substitute family: bbox diagonal + radius_of_gyration/heavy_atom_count/total_atom_count/num_bonds/num_rings proxies; not qcMol exact size definition.",
    },
    {
        "section": "global_features",
...
CANONICAL_SURFACE_ITEMS: List[Dict[str, Any]] = [
    ...
    {"group": "global", "path": "global_features.geometry_size.radius_of_gyration_angstrom", "status": "implemented_proxy"},
    {"group": "global", "path": "global_features.geometry_size.heavy_atom_count_proxy", "status": "implemented_proxy"},
    {"group": "global", "path": "global_features.geometry_size.total_atom_count_proxy", "status": "implemented_proxy"},
    {"group": "global", "path": "global_features.geometry_size.num_bonds_proxy", "status": "implemented_proxy"},
    {"group": "global", "path": "global_features.geometry_size.num_rings_proxy", "status": "implemented_proxy"},
    ...
    {"group": "realspace", "path": "realspace_features.density_shape_descriptor_family_v1", "status": "implemented_proxy"},
    {"group": "realspace", "path": "realspace_features.density_shape_multiscale_family_v1", "status": "implemented_proxy"},
...
CANONICAL_SURFACE_TRAFFIC_LIGHT: List[Dict[str, Any]] = [
    ...
    {
        "path": "global_features.geometry_size.total_atom_count_proxy",
        "status": "implemented_proxy",
        "tier": "yellow",
        "stability": "stable",
        "recommended_default_dependency": True,
        "notes": "Count-based companion for molecule_size family.",
    },
    {
        "path": "global_features.geometry_size.radius_of_gyration_angstrom",
        "status": "implemented_proxy",
        "tier": "yellow",
        "stability": "stable",
        "recommended_default_dependency": True,
        "notes": "Geometry-based compactness companion (equal-weight atom-point Rg).",
    },
    {
        "path": "global_features.geometry_size.num_bonds_proxy",
        "status": "implemented_proxy",
        "tier": "yellow",
        "stability": "stable",
        "recommended_default_dependency": True,
        "notes": "Topology companion for molecule_size family.",
    },
    {
        "path": "realspace_features.density_shape_descriptor_family_v1.sphericity",
        "status": "implemented_proxy",
        "tier": "yellow",
        "stability": "stable",
        "recommended_default_dependency": True,
        "notes": "Shape-family primary scalar; legacy density_sphericity_like remains for compatibility.",
    },
    {
        "path": "realspace_features.density_shape_multiscale_family_v1",
        "status": "implemented_proxy",
        "tier": "yellow",
        "stability": "stable",
        "recommended_default_dependency": True,
        "notes": "Enhancement companion family with 0.50/0.90/0.95 mass-cutoff scales.",
    },
    {
