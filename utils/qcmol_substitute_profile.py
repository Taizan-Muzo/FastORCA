...
QCMOL_ALIGNMENT_MASTER_TABLE: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "current_status": "implemented_proxy",
        "next_action": "keep",
        "completion_criterion": "Density-shape descriptor family v1 remains stable; legacy density_sphericity_like kept as compatibility alias.",
        "notes": "Explicitly proxy substitute; family includes sphericity/asphericity/anisotropy/elongation/planarity.",
    },
    {
        "section": "global_features",
        ...
        "notes": "Frozen substitute family: bbox diagonal + heavy_atom_count/total_atom_count/num_bonds/num_rings proxies; not qcMol exact size definition.",
    },
    {
        "section": "global_features",
